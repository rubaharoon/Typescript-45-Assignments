...
const magician: string[] = ["Ahmed", "David", "Hassan"];
...
const magician1: string[] = ["Ahmed", "David", "Hassan"];
...
const magician2: string[] = ["Ahmed", "David", "Hassan"];
const greatMagicians: string[] = make_great1(magician2);
