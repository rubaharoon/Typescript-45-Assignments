...
let guestList = ["Maha", "Farhana", "Maryam"];
...
let canNotAttendDinner = "Farhana";
...
console.log("=================================================================");
guestList.map((guest) => console.log(`Dear ${guest}, Good News! I found a bigger dinner table so I am invited more peoples.`));
console.log("==========================================================");
let guestBeginning = "Ifrah";
