...
//saying that the username is available.Make sure your comparison is case insensitive. If 'John' has been
// used, 'JOHN' should not be accepted.


let current_users: string[] = ["Admin","Eric","Ali","Fatima","Sarah"];
let new_users: string[] = ["Admin","maheen","Sarah","Maham","Ahmed"];
...
for (let new_user of new_users) {
    if (current_users_lower.includes (new_user.toLowerCase())) {
        console.log(`Sorry ${new_user}, that name is taken, please enter a new username`);
    }
    else {
